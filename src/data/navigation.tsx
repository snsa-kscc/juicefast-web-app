...
const StoreIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M4.02002 7.07031H19.98" stroke="var(--icon-stroke, currentColor)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const ChatIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    <path
      d="M4 6h16c1.1 0 2 .9 2 2v8c0 1.1-.9 2-2 2h-4l-4 3v-3H4c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2z"
      fill="var(--icon-fill)"
      stroke="var(--icon-stroke)"
      strokeWidth="1.5"
      strokeLinecap="round"
...
const WellnessIcon: React.FC = () => (
  <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="12.75" cy="8.5" r="5.5" fill="var(--icon-fill)" stroke="var(--icon-stroke)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <circle cx="12.75" cy="7" r="2" fill="currentColor" />
    <circle cx="8.25" cy="15.5" r="1.5" fill="currentColor" />
    <circle cx="17.75" cy="15" r="1" fill="currentColor" />
  </svg>
);
