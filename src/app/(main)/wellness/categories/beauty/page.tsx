...
import { BEAUTY_SUBCATEGORIES, BEAUTY_CONTENT } from "@/data/wellness-content";
...
export default function BeautyPage() {
  ...
  const handleSubcategoryClick = (subcategoryId: string) => {
    router.push(`/wellness/categories/beauty/${subcategoryId}`);
  };
    ...
    <div className="py-6 font-sans">
      <div className="px-4">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          {BEAUTY_SUBCATEGORIES.map((subcategory) => (
            <div 
              key={subcategory.id} 
        ...
        <ContentGrid 
          items={BEAUTY_CONTENT.slice(0, 4)}
          columns={2}
